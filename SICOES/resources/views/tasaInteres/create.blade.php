...
<h4 style="text-align: center;font-family:  'Trebuchet MS', Helvetica, sans-serif; color: #333333; padding: 50px 0px 5px 0px;"><b>NUEVA TASAS DE INTERES</b></h4>
          ...
          <div class="row">
            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12" id="guardar">
              ...
              <input name="_token" value="{{csrf_token()}}" type="hidden"></input>
                  ...
                  <button class="btn btn-primary btn-lg col-lg-offset-3 col-md-offset-3 col-sm-offset-3" type="submit"><i class="fa fa-floppy-o" aria-hidden="true"></i>  Guardar</button>
                </div>
            </div>
